...
//
var process = function(exec_type, sentences, numberOfTopics, numberOfTermsPerTopic, languages, alphaValue, betaValue, randomSeed, dict_map, rev_dict_map) {
    ...
    if (sentences && sentences.length > 0) {
      ...
      result.topicModel.counters.nw = lda.nw;
      result.topicModel.counters.nwsum = lda.nwsum;
